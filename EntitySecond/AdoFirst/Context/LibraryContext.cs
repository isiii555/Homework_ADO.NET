...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<StudentTeacherLib> StudentTeacherLibs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ISII555;Initial Catalog=Library;Integrated Security=True;Connect Timeout=30;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StudentTeacherLib>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("StudentTeacherLib");
